...
namespace Project1
{
	public static class Sprites
	{
		...
		public static readonly Sprite FoxyHappy = new Sprite(Properties.Resources.FoxyHappyFileName, origin: IntVector.Zero);
		public static readonly Sprite FoxyScared = new Sprite(Properties.Resources.FoxyScaredFileName, origin: IntVector.Zero);
